...
tf<-(weekdays(as.Date(data_correction[,2]))=="poniedzia³ek" |
       weekdays(as.Date(data_correction[,2]))=="wtorek" | weekdays(as.Date(data_correction[,2]))=="œroda" | weekdays(as.Date(data_correction[,2]))=="czwartek" | weekdays(as.Date(data_correction[,2]))=="pi¹tek")
